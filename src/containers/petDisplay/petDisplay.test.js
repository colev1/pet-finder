...
import {searchBySelection} from '../../thunks/searchBySelection';
...
describe('Pet Display', () => {
  ...
  beforeEach(() => {
    mockSearchedPets= [{age: "Adult", animal: "Small & Furry", breed: "Rat", contactInfo: {"address": "1 dog st", "city": "The Colony", email: "bob@gmail.com", state: "TX", "zip": "75056"}, id: "42642357", name: "Curly", photos: ["img1", "img2", "img3", "img4", "img5"], sex: "M", "shelterId": "TX2295", size: "S"}];
    mockIsLoading = false;
    mockHasErrored = ''
    mockFetch = jest.fn()
    mockAddPet = jest.fn()
    mockEvent = { target: { value: 'dog', name: 'animal' }}
    mockEvent2 = { target: { value: 'Baby', name: 'age' }}
  ...
  it('should call handle change on change of input and updates state', () => {
    ...
    select.simulate('change', mockEvent2)
    expect(wrapper.state().animal).toEqual('dog')
		expect(wrapper.state().age).toEqual('Baby')
